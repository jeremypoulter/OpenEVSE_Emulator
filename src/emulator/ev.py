...
class EVSimulator:
    ...
    def __init__(self, battery_capacity_kwh: float = 75.0, max_charge_rate_kw: float = 7.2):
        """
    ...
    def update_charging(self, offered_current_amps: float, voltage: float, delta_time_sec: float):
        """
